...
(title, description, visibility_type, zone_id, city_id, member_id, image, created_at,created_by,priority)
VALUES
('$title','$desc','$type','$zone','$city','$member','$imgName',NOW(),'$uname','$priority')";
