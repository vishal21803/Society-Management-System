    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="card shadow">
            ...
            <div class="card-header bg-warning fw-bold text-dark d-flex justify-content-between align-items-center">
                <span><i class="bi bi-newspaper me-2"></i> Recievable Report</span>
...
<tr>
    ...
    <th class="d-none">Request Date</th>
    <th class="d-none">Approved Date</th>
...
<tr>
    ...
    <td class="d-none"><?= date("Y-m-d",strtotime($row['request_date'])) ?></td>
    <td class="d-none"><?= $row['approved_date'] ? date("Y-m-d",strtotime($row['approved_date'])) : '-' ?></td>
    <td class="d-none">
