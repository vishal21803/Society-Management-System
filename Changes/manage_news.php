  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" id="edit_news_time" name="news_time" class="form-control mb-2">
       ...
       success: function(data)
{
    ...
    $('#edit_news_time').val(data.news_time);
    $('#edit_status').val(data.status);
    $('#edit_toshow_type').val(data.toshow_type);
    $('#final_toshow_id').val(data.toshow_id);

    // ✅ AUTO CHECK FRONT PAGE CHECKBOX
    if(data.news_front == 1){
        $('#showFront').prop('checked', true);
    } else {
        $('#showFront').prop('checked', false);
    }

    if(data.news_img) $('#newsPreview').attr('src', 'upload/news/'+data.news_img);
...
function hinglishToHindi(){ alert("Hinglish → Hindi conversion logic here"); }
function autoTranslateHindi(){ alert("Auto Translate to Hindi logic here"); }
</script>
